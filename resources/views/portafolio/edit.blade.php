    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class=" card-header card-body d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{route('showPortafolio',$portafolio)}}" class="btn btn-danger btn-sm">Regresar</a>
                </div>
                <div class="card-body">

                    <form   action="{{route('updateP',$portafolio)}}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <img src="{{$portafolio -> imagen}}" alt="portafolio-imagen" style="max-width: 300px">
